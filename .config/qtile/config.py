...
#         \/        \/         \/      License:  MIT
# My qtile config. Pretty good stuff.
...
keys = [
		...
		Key([mod], "d", lazy.spawn(f"dmenu_run -p \"Run\" -fn \"{font}:pixelsize=12\" -h 30"), desc = "dmenu"),
		### Windows ###
...
Key([mod, shift], "space", lazy.window.toggle_maximize(), desc = "Toggle maximize window"),
