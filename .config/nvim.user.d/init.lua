local config = {
	...
	colorscheme = "tokyonight", -- or "default_theme",
	...
	highlights = {
		...
		default_theme = function(highlights) -- or a function that returns a new table of colors to set
			local C = require "tokyonightt.colors"
	...
	mappings = {
		...
		n = {
			...
			["<leader>fo"] = false, -- unmap keybind for recent files and map it differently
			["<leader>fr"] = { function() require("telescope.builtin").oldfiles() end, desc = "Search history" },
			[";"] = { ":" },
		},
		t = {
